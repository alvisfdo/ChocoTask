...
import { useDeleteUserMutation, useGetAdminUsersListQuery, useUserActionMutation } from '../redux/api/userApiSlice.js';
...
const AdminUsers = () => {
  ...
  const {data,isLoading,refetch} = useGetAdminUsersListQuery(); // this is for to get the all the users awailable in the database..ignore the name getTeamList it is not relavent to it's operation..
    ...
    <div className='w-full md:px-1 px-0 mb-6'>
      ...
      {/* this render the Title and Button "Add New User" Button */}
        ...
        <Button
          ...
          onClick={() => {setOpen(true), setAdminEdit(true)}}
