...
import {
  ...
  import { FaTasks, FaTrashAlt, FaUsers, FaIndustry, FaUserSecret } from "react-icons/fa";
...
const Sidebar = () => {
    ...
    const sidebarLinks = user?.isSuperUser ? linkData: user?.isAdmin ? linkData.slice(0,7) : linkData.slice(0,5);
 ...
 return (
    <div className='w-full h-full flex flex-col gap-6 p-5'>
        <h1 className='flex gap-1 items-center'>
            ...
            <span className='text-2xl font-bold text-black choco-font-main-screen'>ChocoTask </span>
        </h1>
