...
import { useCreateTaskMutation, useUpdateTaskMutation, useGetAllTaskQuery } from '../../redux/api/taskApiSlice.js';
...
const AddTask = ({ open, setOpen,task }) => {
    ...
    const submitHandler = async (data) => { // Async function to handle form submission
        ...
        try {
            ...
            {/* We need to re-think if the page not refreshed after new task created */}
        ...
        return new Promise((resolve, reject) => { // Return a new Promise
            uploadTask.on(
                ...
                (error) => { // Handle upload errors
                    reject("Upload Error", error); // Reject the Promise with an error
                },
