...
import { useDuplicateTaskMutation, useTrashTaskMutation, useGetAllTaskQuery } from "../../redux/api/taskApiSlice";
...
const TaskDialog = ({task}) => {
  ...
  const { refetch: refetchTrash } = useGetAllTaskQuery({
    strQuery: "",
    isTrashed: "true",
    search: "",
  });
  ...
  const duplicateHandler = async () => {
    try {
      ...
      refetchTrash(); // Refresh trash data
